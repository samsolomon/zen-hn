...
import { initColorMode, initTheme, initFontFamily, initFontSize, initContentWidth, initContrastMode, initSidebarType, initSidebarVisibility, listenForSystemColorModeChanges, listenForSystemContrastModeChanges } from "./colorMode";
...
async function init(): Promise<void> {
  ...
  initFontSize();
  initContentWidth();
  await initSidebarType();
  await initSidebarVisibility();
